...
function GameButtonPressed() {
    ...
    if (startButton === null || startButton === void 0 ? void 0 : startButton.textContent.toLowerCase().includes("play")) {
        ...
        let guess = (_a = document.getElementById("guessBox")) === null || _a === void 0 ? void 0 : _a.value;
        if (!guess) {
            guess = "none";
        }
...
function EditDistance(a, b) {
    let len_a = a.length;
    let len_b = b.length;
    let dp = Array.from({ length: len_a + 1 }, () => Array(len_b + 1).fill(0));
...
function FindClosestGuess(guess) {
